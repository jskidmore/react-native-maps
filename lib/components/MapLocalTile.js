...
const propTypes = {
  ...
  /**
   * Opacity of the tile overlay.
   */
  overlayOpacity: PropTypes.number,

  /**
  * The zoom level at which overzoom is triggered.
  */
  overzoomThreshold: PropTypes.number,

  /**
  * Whether or not to enable overzoom
  */
  overzoomEnabled: PropTypes.bool,
